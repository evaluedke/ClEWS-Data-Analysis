...
- zusammenhänge zwischen wetter/energie variablen und Ländervergleich 
- sehen wo es potential in der erweiterung der erneuerbaren energien gibt? in welchem Bereich ist es sinnvoll energie auszubauen 
...
This dataset describes the climate and energy indicators for 38 European countries from 1979 to present derived from reanalysis and is sourced from the Copernicus climate change service (C3S) (DOI: 10.24381/cds.4bd77450): The parameters include climate variables and indicators from the energy sector which are:
...
The dataset has a temporal resolution of one year and produces a mean value for each country per year. It was subdivided into each parameter. Those had to be combined beforehand.
