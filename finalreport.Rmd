...
We wanted to analyze whether there is a visible difference between windspeed and onshore windpower generation between these countries. Therefore if the differences are sufficient that each country is classified into one cluster. Using the *K-means clustering* algorithm, the clusters are computed and data points assigned to each cluster. annual data
